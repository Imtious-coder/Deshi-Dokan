  ...
  return (
    <footer role="contentinfo">
      <div className="relative bg-white border-t border-b border-black border-opacity-5">
        <div className="mx-auto max-w-7xl px-4 py-14 md:px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
          ...
          <div>
            <h2 className="text-md font-medium uppercase mb-4">Blogs</h2>
            <ul className="mt-8 space-y-4">
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
                <a href="https://shopify.dev/custom-storefronts/hydrogen">
                  Learn about Deshi Dokan
                </a>
              </li>
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
                <a href="https://shopify.dev/custom-storefronts/hydrogen/reference">
                  Best sellers awards 2022
                </a>
              </li>
            </ul>
          </div>
          <div>
            <h2 className="text-md font-medium uppercase mb-4">Join US</h2>
            <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900 mb-4">
              Career
            </li>
            <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
              Sellers
      ...
      <div className="py-6 px-4 md:px-8 bg-gray-50">
        <p className="text-gray-600">© 2022 Deshi Dokan</p>
      </div>
    </footer>
  );
}
